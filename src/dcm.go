...
func (d *Dcm) Usage() {
	...
	fmt.Println("  dcm setup               Git checkout all the repositories for the services.")
	...
	fmt.Println("  dcm build               Run build command that (re)create all the service images.")
	fmt.Println("                          Shorthand version of `dcm run build`.")
	...
	fmt.Println("  dcm update <service>    Update DCM and the services.")
